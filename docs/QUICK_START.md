...
5. 按 `00_project/governance/ROLE_INTERACTION_EXECUTION_POLICY.md` 为当前 Session 建立 Dynamic Role Profile 与 Knowledge Manifest；需要机械执行时，让工具消费 `00_project/governance/GOVERNANCE_EXECUTION_CONTRACTS.yaml`。
...
- Agent 能说明当前 Role、Dynamic Role Profile、阶段、授权和下一项任务。
- 每个动态事实只有一个所有者文件。
